...
from .models import (Restaurant, RestaurantReview, 
                    StarterPic, InsidePic,
                    OutsidePic, DessertPic,
                    MainPic, MenuPic)
...
class CreateRestaurantTest(APITestCase):
    ...
    def test_create_restaurant(self):
        self.data = {"maps": "ChIJd230zfzz5URz8XVIZjiVzYc", "name" : "Les Fricoteurs",
...
class CreateReviewTest(APITestCase):   
    ...
    def setUp(self):         
        self.user = User.objects.create_user(username= "TotoBriac",
                                            email= "toto@gmail.com",
                                            password= "strongPsw")
        self.restaurant = Restaurant.objects.create(  maps = "ChIJd230zfzz5URz8XVIZjiVzYc",
                                                    name = "Les Fricoteurs",
...
class AddPicsTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.restaurant = Restaurant.objects.create(maps = "ChIJd230zfzz5URz8XVIZjiVzYc",
                                                    ...
                                                    restLng = 0.1,
                                                    adress = "21 grande rue")
        self.restaurant_review = RestaurantReview.objects.create(maps= self.restaurant,
